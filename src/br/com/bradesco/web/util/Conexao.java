package br.com.bradesco.web.util;
...
//			tNomeLog = tProps.getProperty ("log");
			...
			tURL 		= "jdbc:mysql://localhost:3306/bradescosolicitaremedio";
			tNomeLog 	= "c:/tmp/bradescosolicitaremedio_db.log";
			File dPadrao = new File("c:/tmp/");
			if(!dPadrao.exists()){
				tNomeLog 	= "c:/tmp/bradescosolicitaremedio_db.log";	
			}
			
/*			tDriver 	= "com.mysql.jdbc.Driver";
			tURL 		= "jdbc:mysql://localhost:3306/bancodenotas";
			tNomeLog 	= "/home/ubuntu/bancodenotas/bancodenotas_db.log";
			File dPadrao = new File("/home/ubuntu/bancodenotas/");
			if(!dPadrao.exists()){
				tNomeLog 	= "/home/ubuntu/bancodenotas/bancodenotas_db.log";	
			}*/
